      ...
      <div className={`${isCroll ? 'fixed left-0 right-0 top-0 z-40 shadow-lg bg-white' : 'bg-white'}`}>
        <Navbar fluid className=' container py-[15px] px-[9px]'>
          <Navbar.Brand  as={Link} to="/">
            ...
            <img width={200}  loading='lazy' src="/assest/logo1.png" alt="Flowbite React Logo" />
          </Navbar.Brand>
          ...
          <Navbar.Collapse>
            <Navbar.Link as={Link} to="/" className='font-bold text-xs text-[14px]' >
              Home
            </Navbar.Link>
            <Navbar.Link as={Link} to="/product/About" className='font-bold text-xs text-[14px]' >About</Navbar.Link>
